...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/django-allauth-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/django-allauth-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add django-allauth
# for installing globally
pixi global install django-allauth
```
...
It is possible to list all of the versions of `django-allauth` available on your platform:
...
```
pixi search django-allauth --channel conda-forge
```
